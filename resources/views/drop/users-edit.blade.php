...
@section('content')
        ...
        <div class="nxl-content">
            ...
            <!-- [ page-header ] end -->
            <!-- [ Main Content ] start -->
            <form action="{{ route('drop.account.update') }}" method="post" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-lg-12">
                        <div class="card stretch stretch-full">
                            ...
                            <div class="card-body general-info">
                                ...
                                <div class="row mb-4 align-items-center">
                                    <div class="col-lg-4">
                                        <label for="logo" class="fw-semibold">Logo: <span class="text-danger">*</span></label>
                                    </div>
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            <div class="input-group-text"><i class="feather-user"></i></div>
                                ...
                                <div class="row mb-4 align-items-center">
                                    <div class="col-lg-4">
                                        <label for="gst_image" class="fw-semibold">GST Image: <span class="text-danger">*</span></label>
                                    </div>
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            <div class="input-group-text"><i class="feather-user"></i></div>
                                ...
                                <div class="row mb-4 align-items-center">
                                    <div class="col-lg-4">
                                        <label for="gst" class="fw-semibold">GST: <span class="text-danger">*</span></label>
                                    </div>
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            <div class="input-group-text"><i class="feather-user"></i></div>
                                            <input type="text" class="form-control" name="gst" 
                                            value="{{ old('gst', $seller->gst) }}" id="" placeholder="GST">                                            
                                        </div>
                                        @error('gst') 
                                            <span class="text-danger text-xs mt-1">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="row mb-4 align-items-center">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            ...
                                            value="{{ old('address', $seller->address) }}" id="" placeholder="Address">                                            
                                        </div>
                                        @error('address') 
                                            <span class="text-danger text-xs mt-1">{{ $message }}</span>
                                        @enderror
