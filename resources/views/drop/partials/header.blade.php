                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown nxl-h-item">
                        <a class="nxl-head-link me-3" data-bs-toggle="dropdown" href="#" role="button" data-bs-auto-close="outside">
                            ...
                            <span class="badge bg-danger nxl-h-badge">25</span>
                        </a>
                        ...
                        <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
                            <div class="dropdown-header">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h6 class="text-dark mb-0">{{ dropinfo()->name }} <span class="badge bg-soft-success text-success ms-1">PRO</span></h6>
                                        <span class="fs-12 fw-medium text-muted">{{dropinfo()->email}}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <a href="{{ route('drop.account.settings') }}" class="dropdown-item">
                                <i class="feather-settings"></i>
                                <span>Account Settings</span>
                            </a>
                            
                            <div class="dropdown-divider"></div>
                            <a onclick="return confirm('Are you sure you want to log out?')" href="{{ route('drop.logout') }}" class="dropdown-item">
