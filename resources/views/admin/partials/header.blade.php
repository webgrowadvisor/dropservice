                        ...
                        <div class="dropdown nxl-h-item nxl-lavel-menu">
                            ...
                            <div class="dropdown-menu nxl-h-dropdown">                              
                                ...
                                <div class="dropdown nxl-level-menu">
                                    <a href="{{route('enquiries')}}" class="dropdown-item">
                                        <span class="hstack">
                    ...
                    <div class="dropdown nxl-h-item">
                        <a class="nxl-head-link me-3" data-bs-toggle="dropdown" href="#" role="button" data-bs-auto-close="outside">
                            ...
                            <span class="badge bg-danger nxl-h-badge">
                                {{ App\Models\ProductEnquiry::whereDate('created_at', $today)->count() }}
                            </span>
                        </a>
                        ...
                        <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-notifications-menu">
                            ...
                            @php
                            $query = App\Models\ProductEnquiry::with('product')->whereDate('created_at', \Carbon\Carbon::today())->latest()->get();
                            @endphp
                            @foreach($query as $enquiry)
                            <div class="notifications-item">
                                {{-- <img src="{{ asset('assets/images/avatar/2.png')}}" alt="" class="rounded me-3 border" /> --}}
                                {!! variantImage($enquiry->product->thumbnail, 60, 60) !!}
                                <div class="notifications-desc">
                                    <a href="javascript:void(0);" class="font-body text-truncate-2-line"> 
                                        <span class="fw-semibold text-dark">{{ $enquiry->name }}, {{ $enquiry->phone }}</span> 
                                        {{ $enquiry->message ?? '----' }}
                                    </a>
