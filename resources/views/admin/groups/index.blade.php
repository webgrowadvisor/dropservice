            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Specifications groups</h5>
                    </div>
                </div>
                                        ...
                                        <tbody>
                                         @foreach($groups as $key => $category)
                                            <tr class="single-item">                                                
                                                <td>
                                                {{ ($groups->currentPage() - 1) * $groups->perPage() + $key + 1 }}
                                                </td>
                                                <td>{{ $category->name }}</td>
                                                <td>
                                                ...
                                                <td>
                                                    <select class="form-control" data-select2-selector="status" data-lead-id="{{ $category->id }}">                                                        
                                                    ...
                                                    <div class="hstack gap-2 justify-content-end">
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li>
                                                                    <a class="dropdown-item" href="{{ route('groups.edit', $category->id) }}">
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <form method="POST" action="{{ route('groups.destroy', $category->id) }}">
                                                                        @csrf @method('DELETE')
