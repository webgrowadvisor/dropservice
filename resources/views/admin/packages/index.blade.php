                ...
                <div class="page-header-right ms-auto">
                    <div class="page-header-right-items">
                        ...
                        <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                            ...
                            <a href="{{ route('ad.packages.create') }}" class="btn btn-primary">
                                    ...
                                    <table class="table table-hover" id="leadList">
                                        ...
                                        @forelse($packages as $key => $package)
                                            <tr class="single-item">                                                
                                                ...
                                                <td>{{ $package->name }}</td>
                                                <td>{{ priceicon() }}{{ number_format($package->price, 2) }}</td>
                                                    ...
                                                    <div class="hstack gap-2 justify-content-end">
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li>
                                                                    <a class="dropdown-item" href="{{ route('ad.packages.edit', $package->id) }}">
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <form method="POST" action="{{ route('ad.packages.destroy', $package->id) }}">
                                                                        @csrf @method('DELETE')
