                ...
                <div class="page-header-right ms-auto">
                    <div class="page-header-right-items">
                        ...
                        <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                            ...
                            <a href="{{ route('ad.products.create') }}" class="btn btn-primary">
                                        ...
                                        <tbody>
                                         @foreach($products as $key => $product)
                                            <tr class="single-item">                                                
                                                ...
                                                <td>
                                                <span class="badge bg-gray-200 text-dark">{{ ($product->stock > 0) ? 'InStock' : 'OutStock' }}</span></td>
                                                <td>{{ $product->stock }}</td>                                                
                                                <td>{{ $product->faqs->count() }}</td>                                                
                                                <td>{{ priceicon() }}{{ $product->base_price }}</td>                                                
                                                <td>
                                                    <ul>
                                                    ...
                                                    <div class="hstack gap-2 justify-content-end">
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li>
                                                                    <a class="dropdown-item" href="{{ route('ad.products.edit', $product->id) }}">
                                                                        <i class="feather feather-edit-3 me-3"></i>
                                                                        <span>Edit</span>
                                                                    </a>
                                                                </li>   
                                                                <li>
                                                                    <a class="dropdown-item" href="{{ route('ad.reviews.create', $product->id) }}">
                                                                        <i class="feather feather-edit-3 me-3"></i>
                                                                        <span>Comment</span>
                                                                    </a>
                                                                </li>   
                                                                <li>
                                                                    ...
                                                                    <form method="POST" action="{{ route('ad.products.destroy', $product->id) }}">
                                                                        @csrf @method('DELETE')
...
<script>        
    ...
    $(document).ready(function() { 
        ...
        $('.update-status').change(function() {
            ...
            $.ajax({
                url: '/admin/products/' + leadId + '/update-status',
                type: 'POST',
                data: {
                    _token: XCSRF_Token,
                    status: status
