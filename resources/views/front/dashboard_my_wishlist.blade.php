                                    ...
                                    <div class="pdpt-bg">
                                        <div class="wishlist-body-dtt">
                                            ...
                                            @forelse($wishlists as $wishlist)
                                                ...
                                                <div class="cart-item" id="wishlist-item-{{ $product->id }}">
                                                    <div class="cart-product-img">
                                                        {!! whshlistImage($product->thumbnail) !!}
                                                        @if(getDiscountPercent($product->mrp_price, $product->base_price))
                                                            <div class="offer-badge">{{ getDiscountPercent($product->mrp_price, $product->base_price) }}</div>
                                                        @endif
                                                    </div>

                                                    <div class="cart-text">
                                                        <a href="{{ route('single_product_view', ['slug' => $product->slug]) }}">
                                                            <h4>{{ $product->name }}</h4>
                                                        </a>
                                                        ...
                                                        <button type="button"
                                                            class="cart-close-btn remove-wishlist"
                                                            data-id="{{ $product->id }}">
                                            ...
                                            {{-- <div class="cart-item">
                                                ...
                                                <div class="cart-text">
                                                    ...
                                                    <div class="cart-item-price"><i
                                                            class="fa-solid fa-indian-rupee-sign"></i> 12</div>
