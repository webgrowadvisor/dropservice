...
class SelProductController extends Controller
{
    ...
    public function index()
    {
        ...
        ->where('seller_id', $sellerId)->latest()->paginate(10);
        
        return view('seller.products.product', compact('products'));
    }
    ...
    public function create()
    {
        ...
        return view('seller.products.add-product', compact('sellers', 'categories', 'brands', 'specGroups'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('seller.products.index')->with('success_msg', 'Product and variants created successfully.');
    }
    ...
    public function edit($id)
    {
        ...
        $specGroups = SpecificationGroup::with('attributes')->get();
        $product = Product::with('variants')->findOrFail($id);
        return view('seller.products.product-edit', compact('product', 'sellers', 'categories', 'specGroups', 'brands'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('seller.products.index')->with('success_msg', 'Product updated successfully.');
    }
